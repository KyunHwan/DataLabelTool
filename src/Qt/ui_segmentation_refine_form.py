...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(1433, 808)
        self.tabWidget = QTabWidget(Form)
        self.tabWidget.setObjectName(u"tabWidget")
        self.tabWidget.setGeometry(QRect(0, 0, 1431, 801))
        self.tab = QWidget()
        ...
        self.listWidget_segIdPaletteList.setGeometry(QRect(1224, 278, 171, 241))
        ...
        self.checkBox_eraserEnabled.setGeometry(QRect(1230, 212, 161, 21))
